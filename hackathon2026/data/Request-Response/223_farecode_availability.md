...
**Path:** Create Reservation > Occupancy Based Samples > Occupancy For 3 – All Adults (RCCL) > Farecode Availability
...
```
Server: nginx
Date: Mon, 27 Mar 2023 09:10:44 GMT
...
```json
{
  ...
  "data": {
    "trackingInfo": {
      "requestId": "6d2d75ed-76f4-4251-863d-f47894138a48",
      "timeStamp": "27-Mar-2023 05:10:38",
      "token": "EQTEMPKEN"
    },
    "cruiseReservation": {
