...
**Path:** Create Reservation > Create Reservation With Packages > Auto-Inclusion of Packages > Create Reservation WITH DoNotAutoIncludePackages Preference > Price Reservation
...
```
Server: nginx
Date: Fri, 03 Nov 2023 10:21:57 GMT
...
```json
{
  ...
  "data": {
    "trackingInfo": {
      "requestId": "baea7c4b-6bdd-4174-b09c-734319d668f1",
      "timeStamp": "03-Nov-2023 06:21:56",
      "token": "EQTEMPKEN"
    },
    "cruiseReservation": {
