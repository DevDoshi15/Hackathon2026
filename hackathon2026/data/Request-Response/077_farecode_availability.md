...
**Path:** Create Reservation > Create Reservation using POS Id > Farecode Availability
...
```
Server: nginx
Date: Fri, 17 Feb 2023 08:12:53 GMT
...
```json
{
  ...
  "data": {
    "trackingInfo": {
      "requestId": "465cef54-625f-48ad-ab36-6fd00bfe8223",
      "timeStamp": "17-Feb-2023 03:12:50",
      "token": "EQTEMPKEN"
    },
    "cruiseReservation": {
