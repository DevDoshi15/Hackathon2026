...
**Path:** Create Reservation > Occupancy Based Samples > Occupancy For 3 (2 Adults + 1 Child) (RCCL) > Farecode Availability
...
```
Server: nginx
Date: Mon, 27 Mar 2023 08:46:05 GMT
...
```json
{
  ...
  "data": {
    "trackingInfo": {
      "requestId": "87111abb-b8a8-4313-8a55-a7e5635dd642",
      "timeStamp": "27-Mar-2023 04:46:00",
      "token": "EQTEMPKEN"
    },
    "cruiseReservation": {
