...
**Path:** Create Reservation > Create Reservation With AddOns > List Dinings
...
```
Server: nginx
Date: Thu, 16 Mar 2023 10:01:02 GMT
...
```json
{
  ...
  "data": {
    "trackingInfo": {
      "requestId": "b6b4271c-78b7-486a-944e-d34bf50df03a",
      "timeStamp": "16-Mar-2023 06:01:01",
      "token": "EQTEMPKEN"
    },
    "cruiseReservation": {
