...
**Path:** Create Reservation > Occupancy Based Samples > Occupancy For 3 (2 Adults + 1 Child) (RCCL) > Category Availability
...
```
Server: nginx
Date: Mon, 27 Mar 2023 08:47:34 GMT
...
```json
{
  ...
  "data": {
    "trackingInfo": {
      "requestId": "66788ca9-6ecb-4077-8f12-d3b29d2b425e",
      "timeStamp": "27-Mar-2023 04:47:27",
      "token": "EQTEMPKEN"
    },
    "cruiseReservation": {
