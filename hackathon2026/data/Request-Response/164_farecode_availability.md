...
**Path:** Create Reservation > Create Reservation With Packages > Auto-Inclusion of Packages > Create Reservation WITHOUT DoNotAutoIncludePackages Preference > Farecode Availability
...
```
Server: nginx
Date: Fri, 03 Nov 2023 10:55:40 GMT
...
```json
{
  ...
  "data": {
    "trackingInfo": {
      "requestId": "50af8486-575b-46a3-96bd-e84351f9276f",
      "timeStamp": "03-Nov-2023 06:55:39",
      "token": "EQTEMPKEN"
    },
    "cruiseReservation": {
