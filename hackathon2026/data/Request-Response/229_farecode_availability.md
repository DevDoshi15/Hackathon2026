...
**Path:** Create Reservation > Occupancy Based Samples > Occupancy For 4 – All Adults (RCCL) > Farecode Availability
...
```
Server: nginx
Date: Mon, 27 Mar 2023 10:06:42 GMT
...
```json
{
  ...
  "data": {
    "trackingInfo": {
      "requestId": "ebdd6d14-d9ec-4fb6-b290-5a9126941945",
      "timeStamp": "27-Mar-2023 06:06:37",
      "token": "EQTEMPKEN"
    },
    "cruiseReservation": {
