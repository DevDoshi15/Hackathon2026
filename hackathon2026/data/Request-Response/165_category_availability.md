...
**Path:** Create Reservation > Create Reservation With Packages > Auto-Inclusion of Packages > Create Reservation WITHOUT DoNotAutoIncludePackages Preference > Category Availability
...
```
Server: nginx
Date: Fri, 03 Nov 2023 10:59:57 GMT
...
```json
{
  ...
  "data": {
    "trackingInfo": {
      "requestId": "c2d16bdc-5a48-49fd-9fe3-a9762396a11b",
      "timeStamp": "03-Nov-2023 06:59:55",
      "token": "EQTEMPKEN"
    },
    "cruiseReservation": {
