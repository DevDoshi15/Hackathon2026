...
**Path:** Create Reservation > Create Reservation With Insurance > Create Reservation
...
```
Server: nginx
Date: Fri, 17 Feb 2023 14:42:32 GMT
...
```json
{
  ...
  "data": {
    "trackingInfo": {
      "requestId": "afbb8837-abf7-4430-a350-05b0eee53b7a",
      "timeStamp": "17-Feb-2023 09:42:04",
      "token": "EQTEMPKEN"
    },
    "id": 66094,
    "agencyConfirmation": "VPFNKI7",
    "cruiseReservation": {
      "id": 114074,
      "status": 6,
      "reservationReferences": {
        "confirmationNumber": "45605667"
      },
      "pos": {
        "id": 2119,
        "apiId": "MSC",
