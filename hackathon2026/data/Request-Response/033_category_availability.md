...
**Path:** Category Availability > B2C > Category Availability
...
//This request contains only mandatory elements
{
    "cruiseReservation": {
        ...
        "cruise": {
            "packageId": 1340642 // Here Type of Office should be passed
        }
    },
    "customers": [
        {
...
```
Server: nginx
Date: Fri, 24 Mar 2023 15:07:46 GMT
...
```json
{
  ...
  "data": {
    "trackingInfo": {
      "requestId": "3930807b-c83d-4ef4-a7ff-f3d0302c7152",
      "timeStamp": "30-Mar-2023 13:57:03",
      "token": "EQTEMPKEN"
    },
    "cruiseReservation": {
