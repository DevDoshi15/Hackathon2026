...
**Path:** Create Reservation > Create Reservation With Grats/AddOns For NCL > Hold Cabin
...
```
Server: nginx
Date: Fri, 17 Feb 2023 15:35:09 GMT
...
```json
{
  ...
  "data": {
    "trackingInfo": {
      "requestId": "35f8bb08-de48-4fde-a9a2-62bb70bafa80",
      "timeStamp": "17-Feb-2023 10:35:06",
      "token": "EQTEMPKEN"
    },
    "cruiseReservation": {
