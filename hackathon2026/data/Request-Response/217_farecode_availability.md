...
**Path:** Create Reservation > Occupancy Based Samples > Occupancy For 3 (2 Adults + 1 Child) Kids Special Package (RCCL) > Farecode Availability
...
```
Server: nginx
Date: Mon, 27 Mar 2023 11:07:38 GMT
...
```json
{
  ...
  "data": {
    "trackingInfo": {
      "requestId": "c6ba0b51-9c7e-4acc-a390-4731b59c54dd",
      "timeStamp": "27-Mar-2023 07:07:33",
      "token": "EQTEMPKEN"
    },
    "cruiseReservation": {
