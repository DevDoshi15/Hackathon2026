...
**Path:** Farecode Availability > B2B v/s B2C > B2C > Farecode Availability
...
```
Server: nginx
Date: Thu, 18 May 2023 16:02:10 GMT
...
```json
{
  ...
  "data": {
    "trackingInfo": {
      "requestId": "e460dc0b-f2c6-40b4-b6d5-a4227323c86b",
      "timeStamp": "18-May-2023 12:01:58",
      "token": "EQTEMPKEN"
    },
    "cruiseReservation": {
