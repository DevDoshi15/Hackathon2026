...
**Path:** Create Reservation > Create Reservation using POS Id > Special Services
...
```
Server: nginx
Date: Fri, 17 Feb 2023 08:22:51 GMT
...
```json
{
  ...
  "data": {
    "trackingInfo": {
      "requestId": "59156079-0fee-4874-a1ef-390eb0f78da8",
      "timeStamp": "17-Feb-2023 03:22:49",
      "token": "EQTEMPKEN"
    },
    "cruiseReservation": {
