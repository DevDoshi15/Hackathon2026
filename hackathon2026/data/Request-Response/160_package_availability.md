...
**Path:** Create Reservation > Create Reservation With Packages > Auto-Inclusion of Packages > Create Reservation WITH DoNotAutoIncludePackages Preference > Package Availability
...
```
Server: nginx
Date: Fri, 03 Nov 2023 08:19:24 GMT
...
```json
{
  ...
  "data": {
    "trackingInfo": {
      "requestId": "97af06b9-a09f-49f1-9759-5aa39589af8d",
      "timeStamp": "03-Nov-2023 04:19:03",
      "token": "40768d9d-b570-46c0-b3be-a517f0da8f32"
    },
    "cruiseReservation": {
