...
**Path:** Create Reservation > Create Reservation With AddOns > Cabin Availability
...
```
Server: nginx
Date: Thu, 16 Mar 2023 09:59:20 GMT
...
```json
{
  ...
  "data": {
    "trackingInfo": {
      "requestId": "95d5e435-f046-428c-8d79-4f7b0724c44e",
      "timeStamp": "16-Mar-2023 05:59:11",
      "token": "EQTEMPKEN"
    },
    "cruiseReservation": {
