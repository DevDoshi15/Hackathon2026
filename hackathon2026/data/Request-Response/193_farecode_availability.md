...
**Path:** Create Reservation > Group Reservation > Norwegian Cruiseline > Farecode Availability
...
```
Server: nginx
Date: Wed, 15 Mar 2023 12:33:06 GMT
...
```json
{
  ...
  "data": {
    "trackingInfo": {
      "requestId": "f63e80f3-6754-44e7-9d99-d2515a8ae1e7",
      "timeStamp": "15-Mar-2023 08:33:00",
      "token": "EQTEMPKEN"
    },
    "cruiseReservation": {
