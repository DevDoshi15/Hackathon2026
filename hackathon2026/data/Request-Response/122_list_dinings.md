...
**Path:** Create Reservation > Create Reservation With Grats/AddOns For NCL > List Dinings
...
```
Server: nginx
Date: Fri, 17 Feb 2023 15:34:22 GMT
...
```json
{
  ...
  "data": {
    "trackingInfo": {
      "requestId": "db12902a-d47e-4a09-a24c-8479c9f7160c",
      "timeStamp": "17-Feb-2023 10:34:22",
      "token": "EQTEMPKEN"
    },
    "cruiseReservation": {
