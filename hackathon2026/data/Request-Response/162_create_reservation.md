...
**Path:** Create Reservation > Create Reservation With Packages > Auto-Inclusion of Packages > Create Reservation WITH DoNotAutoIncludePackages Preference > Create Reservation
...
```json
{
    "cruiseReservation": {
        ...
        "ReservationPreferences": [ // Here we add this reference as true to avoid auto including certain packages
            {
                "Type": "DoNotAutoIncludePackages",
                "Value": true
            }
        ]
    },
...
```
Server: nginx
Date: Fri, 03 Nov 2023 10:51:12 GMT
...
```json
{
  ...
  "advisories": [
    ...
    },
    {
      "code": "35",
      "message": "CONSUMER ADVICE",
      "description": "CABIN NOTES:  CONNECTS WITH 1078",
      "type": "Information"
    },
    {
      "code": "35",
  ...
  "data": {
    "trackingInfo": {
      "requestId": "8fd59b1a-e015-4c93-9d03-48a08c882cdc",
      "timeStamp": "03-Nov-2023 06:51:04",
      "token": "EQTEMPKEN"
    },
    "id": 88715,
