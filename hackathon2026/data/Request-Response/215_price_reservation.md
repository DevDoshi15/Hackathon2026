...
**Path:** Create Reservation > Occupancy Based Samples > Occupancy For 3 (2 Adults + 1 Child) (RCCL) > Price Reservation
...
```
Server: nginx
Date: Mon, 27 Mar 2023 08:41:11 GMT
...
```json
{
  ...
  "data": {
    "trackingInfo": {
      "requestId": "1090bba5-086b-473f-a271-21c6c1b8f2ac",
      "timeStamp": "27-Mar-2023 04:41:09",
      "token": "EQTEMPKEN"
    },
    "cruiseReservation": {
