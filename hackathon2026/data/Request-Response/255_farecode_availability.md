...
**Path:** Create Reservation > Create Reservation - Payment Pending Confirmation Flag > Farecode Availability
...
```json
{
    "cruiseReservation": {
        ...
        "pos": {
          "id": 2465,
          "type": "B2C" // to get only certain fare codes like Bookable online, e.g. PPSRVCHG won't be available here, which was present in case of B2B sample
        }
    },
    "customers": [
        {
...
```
Server: nginx
Date: Mon, 25 Sep 2023 11:09:19 GMT
...
```json
{
  ...
  "data": {
    "trackingInfo": {
      "requestId": "d8930a7d-f9ad-447b-a62c-d796c5ba33ac",
      "timeStamp": "25-Sep-2023 07:09:18",
      "token": "EQTEMPKEN"
    },
    "cruiseReservation": {
