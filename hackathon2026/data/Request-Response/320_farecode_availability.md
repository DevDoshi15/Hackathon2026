...
**Path:** Modify Reservation > Create Reservation With Insurance then Modify By Adding Gratuities > Farecode Availability
...
```
Server: nginx
Date: Thu, 04 May 2023 08:29:36 GMT
...
```json
{
  ...
  "data": {
    "trackingInfo": {
      "requestId": "730d329d-c9f5-4f02-a298-d900bcbdc0a3",
      "timeStamp": "04-May-2023 04:29:33",
      "token": "EQTEMPKEN"
    },
    "cruiseReservation": {
