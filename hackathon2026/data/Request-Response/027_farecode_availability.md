...
**Path:** Farecode Availability > Farecode Availability
...
```
Server: nginx
Date: Wed, 01 Feb 2023 10:50:35 GMT
...
```json
{
  ...
  "data": {
    "trackingInfo": {
      "requestId": "517e5810-3db1-4bf8-8d8b-be7238a96ce9",
      "timeStamp": "01-Feb-2023 05:50:31",
      "token": "EQTEMPKEN"
    },
    "cruiseReservation": {
